...
void server_c::proc_on_init(void) {
	...
	// 打印配置信息
	logger("cfg_taddrs: %s, cfg_raddrs: %s, cfg_maxthrds: %d, cfg_ctimeout: %d, cfg_rtimeout: %d",
		"cfg_rsession: %d", cfg_taddrs, cfg_raddrs, cfg_maxthrds, cfg_ctimeout, cfg_rtimeout, cfg_rsession);
}
